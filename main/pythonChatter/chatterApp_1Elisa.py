...
class Chatter:
    ...
    def __init__(self, host, portSender, portReciever, dataTable):
        self.host_ = host
    ...
    def replyOscHandler( self, addr, tags, stuff, source ):
        ...
        if ( self.counter % 2 == 0 ):        # TODO switching between the chatters
            ...
            # answer += "DataInsulter | "
            answerTMP = ai.answerFromText( input_sentence, self.resultDict, self.dataTable )
...
chatterElisa = Chatter( host, portSender, portReciever, dataTableShitTalk )
